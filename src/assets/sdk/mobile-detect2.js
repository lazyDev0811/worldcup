...
export async function getDeviceInfo() {
    ...
    deviceInfo.isPad = Platform.isPad();
    ...
    deviceInfo.deviceTypeId = DeviceInfo.getDeviceId();

    //returns the device pixel density
    //see https://facebook.github.io/react-native/docs/pixelratio
    deviceInfo.pixelRatio = PixelRatio.get();

    if (Platform.OS === 'android') {
        console.log('device is android');
        deviceInfo.androidApiLevel =  await deviceInfo.getApiLevel();
    }else if (Platform.OS === 'ios') {
        console.log('device is ios');
    }else {
        //running an unsupported os
        console.log('warning unsupported OS:'+ Platform.OS);
    }
